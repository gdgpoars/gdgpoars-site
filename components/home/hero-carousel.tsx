          ...
          <div className="space-y-8 text-center lg:text-left">
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4">
              <div className="flex items-center gap-2 rounded-2xl bg-card px-4 py-2 shadow-lg glass-border">
                <span className="text-2xl font-bold text-google-blue">700+</span>
                <span className="text-sm text-muted-foreground">Membras e membros</span>
              </div>
              <div className="flex items-center gap-2 rounded-2xl bg-card px-4 py-2 shadow-lg glass-border">
                <span className="text-2xl font-bold text-google-green">30+</span>
