...
const partnerEvents: PartnerEvent[] = [
  {
    ...
    description: 'Um dos maiores eventos de desenvolvimento de software do Brasil, reunindo pessoas desenvolvedoras de todo o pais.',
    date: '15-17 de Agosto, 2026',
    location: 'Joinville, SC',
    websiteUrl: 'https://codecon.dev',
    whatsappGroupUrl: '#',
    couponCode: 'GDGPOA20',
  ...
  },
  {
    ...
    description: 'Conferencia focada em frontend com palestras sobre as tecnologias mais recentes do mercado.',
  ...
  {
    id: '3',
    name: 'TDC Porto Alegre 2026',
    description: 'The Developers Conference chega em Porto Alegre com trilhas de diversas tecnologias e linguagens.',
    date: '10-12 de Dezembro, 2026',
    location: 'Porto Alegre, RS',
    websiteUrl: 'https://thedevconf.com',
    whatsappGroupUrl: '#',
    logoPlaceholder: 'TDC',
